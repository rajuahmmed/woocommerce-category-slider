<h4>Carousel Style 10</h4>

<div class="wcsn-slider wcsn-pro-14">
	...
	<div class="wcsn-slider-content-wrapper">
        ...
        <div class="wcsn-slider-header" style="background-color: rgba(0, 0, 0, 0.5);color: #fff;">
        ...
        <div class="wcsn-slider-footer" style="background-color: rgba(0, 0, 0, 0.5);color: #fff;">
