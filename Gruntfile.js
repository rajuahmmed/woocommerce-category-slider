module.exports = function(grunt) {
    ...
    concat: {
        options: {
            ...
            woo_category_slider: {
                src: [
                    'assets/js/vendor/*.js',
                    'assets/js/src/woo-category-slider.js',
                ],
                    dest: 'assets/js/woo-category-slider.js'
            }
        },
    // jshint
    jshint: {
    ...
    uglify: {
        all: {
            files: {
                'assets/js/woo-category-slider.min.js': ['assets/js/woo-category-slider.js']
            },
            options: {
        ...
        sass:   {
            all: {
                files: {
                    'assets/css/woo-category-slider.css': 'assets/css/sass/woo-category-slider.scss'
                }
            }
        },
            ...
            target: {
                options: {
                    exclude: ['build/.*', 'node_modules/*', 'assets/*'],
                        ...
                        potFilename: 'woo-category-slider.pot', // Name of the POT file.
      ...
      compress: {
        main: {
            options: {
                mode: 'zip',
                    archive: './build/woo-category-slider-' + pkg.version + '.zip'
            },
            expand: true,
                cwd: 'build/',
                src: ['**/*'],
                dest: 'woo-category-slider'
        }
    },
    server: {
        options: {
